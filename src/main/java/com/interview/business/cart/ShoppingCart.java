...
public class ShoppingCart {
  ...
  public Double getDeliveryCost() {
    return deliveryCostManager
        .getDeliveryCost(cartManager.getNumberOfDeliveries(), cartManager.getNumberOfProducts());
  }
  ...
  public String toString() {
    ...
    Double couponDiscount = discountManager
        .getCouponDiscount(cartManager.getCartTotalAmountBeforeDiscount());
    builder.append("Total Price All Cart :\t").append(numberFormat.format(cartManager.getCartTotalAmountBeforeDiscount()));
    builder.append("\nTotal Campaign Discount  :\t").append(numberFormat.format(campaignDiscount));
    builder.append("\nTotal Coupon Discount  :\t").append(numberFormat.format(couponDiscount));
    builder.append("\nTotal Amount  :\t").append(numberFormat.format(getTotalAmountAfterDiscounts()));
    builder.append("\nDelivery Cost :\t").append(numberFormat.format(getDeliveryCost()));
